<div
        ...
        <div class="flex items-start w-full gap-3 sm:justify-end">
            <div wire:ignore x-data="{
                init() {
                    ...
                    const defaultFrom = @js($from);
                    const defaultTo = @js($to);
    ...
    <div class="max-w-full overflow-x-hidden">
        <div wire:ignore id="chartThree" data-series='@json($series)' data-categories='@json($categories)' class="w-full min-w-0"></div>
    </div>
</div>
