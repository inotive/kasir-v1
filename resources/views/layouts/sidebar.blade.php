        ...
        <a href="{{ route('pos.index') }}" 
           ...
           :class="[
            ...
            <span class="flex items-center justify-center"
                 :class="isActive('{{ route('pos.index', [], false) }}') ? 'text-white' : 'text-gray-400'">
                                ...
                                <li>
                                            ...
                                            <span
                                                ...
                                                @if (!empty($item['new']))
                                                    <span class="absolute right-10"
                                                        :class="isActive('{{ $item['path'] ?? '' }}', {{ json_encode($item['exact'] ?? false) }}) ?
                                                ...
                                                @foreach ($item['subItems'] as $subItem)
                                                    <li>
                                                        <a href="{{ $subItem['path'] }}" wire:navigate class="menu-dropdown-item"
                                                            :class="isActive('{{ $subItem['path'] }}', {{ json_encode($subItem['exact'] ?? false) }}, {{ json_encode($subItem['exclude'] ?? []) }}) ?
                                    ...
                                    @else
                                        ...
                                        <a href="{{ $item['path'] }}" wire:navigate class="menu-item group"
                                            :class="[
                                                isActive('{{ $item['path'] }}', {{ json_encode($item['exact'] ?? false) }}) ? 'menu-item-active' :
                                                'menu-item-inactive',
                                            ...
                                            <!-- Icon -->
                                            <span
                                                :class="isActive('{{ $item['path'] }}', {{ json_encode($item['exact'] ?? false) }}) ? 'menu-item-icon-active' :
