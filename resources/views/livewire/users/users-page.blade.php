                            ...
                            <div x-data="{ show: false }" class="relative">
                                ...
                                >
                                    ...
                                    <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.644C3.48 8.113 7.55 5 12 5c4.45 0 8.52 3.113 9.964 6.678.13.314.13.67 0 .984C20.52 15.887 16.45 19 12 19c-4.45 0-8.52-3.113-9.964-6.678Z" />
                        ...
                        <div>
                            ...
                            <div x-data="{ show: false }" class="relative">
                                <input
                                    ...
                                    :type="show ? 'text' : 'password'"
                                    autocomplete="new-password"
                                    aria-invalid="{{ $errors->has('passwordConfirmation') ? 'true' : 'false' }}"
                                    aria-describedby="{{ $errors->has('passwordConfirmation') ? 'error-passwordConfirmation' : '' }}"
                                    class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent pl-4 pr-11 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-brand-300 focus:ring-brand-500/10 focus:outline-hidden focus:ring-3"
                                />
                                <button
                                    type="button"
                ...
                <form wire:submit="updateUser" autocomplete="off" class="space-y-4 p-5">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div x-data="{ show: false }" class="relative">
                                <input
                                    wire:model.live="editingPassword"
                                    :type="show ? 'text' : 'password'"
                                    autocomplete="new-password"
                                    aria-invalid="{{ $errors->has('editingPassword') ? 'true' : 'false' }}"
                                    aria-describedby="{{ $errors->has('editingPassword') ? 'error-editingPassword' : '' }}"
                                    class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent pl-4 pr-11 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-brand-300 focus:ring-brand-500/10 focus:outline-hidden focus:ring-3"
                                />
                                <button
                                    type="button"
                        ...
                        <div>
                            ...
                            <div x-data="{ show: false }" class="relative">
                                <input
                                    wire:model.live="editingPasswordConfirmation"
                                    :type="show ? 'text' : 'password'"
                                    autocomplete="new-password"
                                    aria-invalid="{{ $errors->has('editingPasswordConfirmation') ? 'true' : 'false' }}"
                                    aria-describedby="{{ $errors->has('editingPasswordConfirmation') ? 'error-editingPasswordConfirmation' : '' }}"
                                    class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent pl-4 pr-11 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 focus:border-brand-300 focus:ring-brand-500/10 focus:outline-hidden focus:ring-3"
                                />
                                <button
                                    type="button"
