...
use App\Livewire\Tenants\TenantFormPage;
use App\Livewire\Tenants\TenantListPage;
...
Route::prefix('admin')->middleware('admin.domain')->group(function () {
    ...
    Route::middleware(['auth', 'active'])->group(function () {
        ...
        Route::get('/tenants/{tenant}/edit', TenantFormPage::class)->name('tenants.edit');
        Route::get('/tenants/create', TenantFormPage::class)->name('tenants.create');
        Route::get('/tenants', TenantListPage::class)->name('tenants.index');
    });
