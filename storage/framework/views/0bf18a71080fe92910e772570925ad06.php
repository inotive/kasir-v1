...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCashier): ?>
    <div class="relative" x-data="{
        ...
        async refresh() {
            this.loading = true;
            try {
                const res = await fetch('<?php echo e(route('midtrans.unprocessed', [], false)); ?>', {
        ...
        >
            ...
            <div class="mt-3 grid grid-cols-2 gap-2">
                <a href="<?php echo e(route('pos.index', [], false)); ?>" class="shadow-theme-xs inline-flex h-10 items-center justify-center rounded-lg border border-gray-300 bg-white px-3 text-xs font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                    Buka POS
                </a>
...
<?php /**PATH /home/u592471275/domains/ciyemon.com/public_html/resources/views/components/header/midtrans-notification.blade.php ENDPATH**/ ?>