    ...
    <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div class="w-full">
            ...
            <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                Statistik pergerakan penjualan per periode
            </p>
        </div>
        ...
        <div class="flex items-start w-full gap-3 sm:justify-end">
            <div wire:ignore x-data="{
                init() {
                    ...
                    const defaultFrom = <?php echo \Illuminate\Support\Js::from($from)->toHtml() ?>;
                    const defaultTo = <?php echo \Illuminate\Support\Js::from($to)->toHtml() ?>;
...
<?php /**PATH /home/u592471275/domains/ciyemon.com/public_html/resources/views/components/ecommerce/statistics-chart.blade.php ENDPATH**/ ?>