...
<head>
    ...
    <script defer src="<?php echo e(asset('js/printer-system/bluetooth-service.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/printer-system/receipt-templates.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/printer-system/print-queue.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/printer-system/printer-manager.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/printer-system/printer-ui.js')); ?>"></script>
                        ...
                        <div class="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
                            ...
                            <div class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="<?php echo e(route('settings.index', ['section' => 'printers'], false)); ?>" wire:navigate @click="close()" class="text-xs font-semibold text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300">Pengaturan</a>
                                </div>
...
<?php /**PATH /home/u592471275/domains/ciyemon.com/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>