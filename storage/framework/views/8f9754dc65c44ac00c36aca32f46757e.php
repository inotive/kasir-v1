            ...
            <template x-for="issue in issues" :key="issue.role">
                <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="mt-3 flex items-center justify-end gap-2">
                        <a href="<?php echo e(route('settings.index', ['section' => 'printers'], false)); ?>" wire:navigate @click="closeDropdown()" class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                            Buka Pengaturan
                        </a>
...
<?php /**PATH /home/u592471275/domains/ciyemon.com/public_html/resources/views/components/header/notification-dropdown.blade.php ENDPATH**/ ?>