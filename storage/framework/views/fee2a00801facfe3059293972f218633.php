                    ...
                    <div>
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            ...
                            <button
                                ...
                                class="absolute top-1/2 right-3 -translate-y-1/2 rounded-lg px-2 py-1 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                            >
...
<?php endif; ?>
                    ...
                    <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                        <input wire:model.live="remember" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500/20 dark:border-gray-700" />
                        Ingat saya
                    </label>
...
<div style="background-image: url('<?php echo e(asset('images/shape/bg-login.png')); ?>'); background-position: center; background-repeat: no-repeat; background-size: contain;" 
     class="relative hidden h-full w-full lg:grid lg:w-1/2 bg-slate-50 dark:bg-white/5 border-l border-slate-200 dark:border-white/10">
...
<?php /**PATH /home/u592471275/domains/ciyemon.com/public_html/resources/views/livewire/auth/sign-in-page.blade.php ENDPATH**/ ?>